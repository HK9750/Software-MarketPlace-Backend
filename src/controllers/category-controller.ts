...
export const getAllCategories = AsyncErrorHandler(async (req: Request, res: Response, next: NextFunction) => {
...
export const getCategory = AsyncErrorHandler(async (req: Request, res: Response, next: NextFunction) => {
